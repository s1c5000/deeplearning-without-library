...
training_data = np.loadtxt('C:/Users/s1c50/python_study/TensorFlow_Machine_Learning/mnist_train.csv',
 delimiter=',', dtype=np.float32)

# 0~9 숫자 이미지가 784개의 숫자 (28X28) 로 구성되어 있는 test data 읽어옴
test_data = np.loadtxt('C:/Users/s1c50/python_study/TensorFlow_Machine_Learning/mnist_test.csv',
 delimiter=',', dtype=np.float32)
